...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='assets/img/theater.png' width='24' height='28'>&nbsp;Hot Meals": theaterLayer,
    "<img src='assets/img/museum.png' width='24' height='28'>&nbsp;Pantries": museumLayer
  },
  "Reference": {
...
$(document).one("ajaxStop", function () {
 ...
 // geonamesBH.initialize();
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/museum.png' width='24' height='28'>&nbsp;Hot Meals</h4>",
